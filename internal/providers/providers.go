...
// docs/providers/cursor.md names along with what that costs. What still differs
// per provider is spelled at each of those tables, and AcceptsMCPServer below
// is the one split this file owns.
