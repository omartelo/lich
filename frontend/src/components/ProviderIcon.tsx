...
// Brand marks for the AI providers. The Claude/Codex/opencode/oh-my-pi SVG paths
// are vendored from @lobehub/icons (MIT — github.com/lobehub/lobe-icons), inlined
// so lich does not depend on that package's ~500-package tree (antd, shiki, …) for
// four icons. Crush has no lobehub mark yet and borrows a lucide glyph; shell
...
const PATHS: Partial<Record<SessionKind, string>> = {
  ...
  // oh-my-pi is a Pi fork and wears lobehub's Pi mark. Upstream draws it as two
  // paths under fill-rule="evenodd"; concatenated they render identically under
