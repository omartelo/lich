...
// terminal — the sidebar writing a delegate request at the prompt — and
// honoured by the TerminalView that owns the session. Page-internal:
// app-events carries what the backend has to say, never what one part of the
// page asks of another.
//
